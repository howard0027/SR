...
def create_datasets(args):
    div2k = DIV2K(
        ...
        os.path.join(args.data_path, f'div2k_cache_x{args.scale}'),
        train=True, 
    ...
    if 'Set5' in args.eval_sets:
        set5_hr_path = os.path.join(args.data_path, f'benchmark/Set5/HR/X{args.scale}')
        set5_lr_path = os.path.join(args.data_path, f'benchmark/Set5/LR')
    ...
    if 'Set14' in args.eval_sets:
        set14_hr_path = os.path.join(args.data_path, f'benchmark/Set14/HR/X{args.scale}')
    ...
    if 'B100' in args.eval_sets:
        b100_hr_path = os.path.join(args.data_path, f'benchmark/B100/HR/X{args.scale}')
    ...
    if 'Urban100' in args.eval_sets:
        u100_hr_path = os.path.join(args.data_path, f'benchmark/Urban100/HR/X{args.scale}')
    ...
    if 'Manga109' in args.eval_sets:
        manga_hr_path = os.path.join(args.data_path, f'benchmark/Manga109/HR/X{args.scale}')
